...
COPY __init__.py bot_main.py config.py knowledge.py ai_responder.py forum_sync.py i18n.py responses.py forum_search.py forum_catalog.py faq.py ./firstmyko_bot/
